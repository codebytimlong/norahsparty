...
const partyAddressString = ref('251 Pump House Rd, Annapolis, MD, 21403')
const partyAddressArray = ['251 Pump House Rd', 'Annapolis, MD, 21403']
const googleMapsLink = 'https://maps.app.goo.gl/pt1a3tmeewk9zSiz5'
...
<main
  ...
  :class="$theme.bg">
  <article
    class="md:rounded-lg md:w-3/4 md:max-w-[960px] md:my-12 md:mx-auto md:overflow-hidden md:border-4 md:border-white/10"
